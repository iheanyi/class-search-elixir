defmodule API do
  ...
  def process_section_html(first_section) do
      ...
      instructor_full_name = Floki.text(tenth_cell)
      #IO.puts instructor_full_name
      instructor_name_array = String.split(instructor_full_name, ",", trim: true)
      name_length = length instructor_name_array
      IO.puts name_length
      ...
      if name_length >= 2 do
        ...
        # Instructor is to be determined/announced, so default to that.
        instructor = "TBA"
      end
